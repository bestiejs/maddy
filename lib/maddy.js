...
(function () {
  // Convenience aliases.
  var toString = {}.toString, slice = [].slice, apply = Function.prototype.apply,
  ...
  forEach = Maddy.forEach = Maddy.each = (function () {
    ...
    if (!length) {
      ...
      properties = ['constructor', 'toString', 'valueOf', 'isPrototypeOf', 'hasOwnProperty', 'propertyIsEnumerable', 'toLocaleString'];
  ...
  function getClassOf(object) {
    ...
    if (object === null) {
      ...
      match = className.exec(toString.call(object));
